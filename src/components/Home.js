...
const Home = () => {
    ...
    return (
                ...
                <div id="slide1" className="carousel-item relative w-full backdrop-brightness-50 bg-white/30">
                    <img src="https://m.economictimes.com/thumb/msid-92062293,width-1200,height-900,resizemode-4,imgsize-57232/from-diagnosis-to-treatment-from-prevention-to-therapeutics-artificial-intelligence-has-made-many-things-possible-which-had-been-absolutely-unachievable-before-.jpg" className="w-full blur-sm" alt=''/>
